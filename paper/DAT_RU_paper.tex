...
All analyses were conducted in Python 3.12 using NumPy, SciPy, pandas, statsmodels, matplotlib, and seaborn. UMAP dimensionality reduction used the umap-learn library. Word corpus frequencies were obtained from the wordfreq library (Speer et al., 2018). Mixed-effects models used statsmodels MixedLM. All analysis scripts are available at \url{https://github.com/mool32/dat-ru-paper}.
...
The anonymized dataset (scores, words, timestamps, time spent) and all analysis scripts are available at \url{https://github.com/mool32/dat-ru-paper}. User-agent strings are excluded to protect participant privacy.
